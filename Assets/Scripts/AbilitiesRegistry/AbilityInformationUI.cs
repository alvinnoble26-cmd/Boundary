...
public sealed class AbilityInformationUI : MonoBehaviour
{
    ...
    private static readonly string[] AbilityDescriptions =
    {
        ...
        "<b>SLIDE</b>  •  2.5s cooldown\nUse while touching the floor or an intended wall surface. Burst into a fast 0.5s slide; jump during it to carry momentum and gain extra height.",
        ...
        "<b>HOLLOW</b>  •  5s cooldown\nAim and fire a widening 60m void blast after a 0.75s charge. The blast lasts 2s and deals continuous damage to opponents caught inside it.",
