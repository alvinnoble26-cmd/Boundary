...
public class  ForceField : MonoBehaviour
{
    ...
    public const float VisualBrightnessMultiplier = 6f;
    public const int MiniStarPointCount = 5;
    public const float AttractFlashRadius = 60f;
    public const float AttractFlashPeakIntensity = 5400f;
    public const float AttractFlashDuration = 2.1f;
    public const float RepelFlashRadius = 60f;
    public const float RepelFlashPeakIntensity = 5400f;
