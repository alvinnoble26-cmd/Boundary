...
namespace PurrNet.Editor
{
        ...
        IPostprocessBuildWithReport
    {
        ...
        {
            const string PATH = "Assets/Game/Resources/PurrHashes.json";
            const string VERSION = "Assets/Game/Resources/PurrVersion.json";
            ...
            if (Directory.Exists("Assets/Game/Resources"))
            {
                var files = Directory.GetFiles("Assets/Game/Resources");
                var dirs = Directory.GetDirectories("Assets/Game/Resources");
                ...
                {
                    Directory.Delete("Assets/Game/Resources");
                    if (File.Exists("Assets/Game/Resources.meta"))
                        File.Delete("Assets/Game/Resources.meta");
                }
            }
