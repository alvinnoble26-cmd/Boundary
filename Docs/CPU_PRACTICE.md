...
Base's standable platform and matching visual now use an 8.25-unit radius (1.5 times the former 5.5 units), giving players a larger landing area for its one-second lifetime.
